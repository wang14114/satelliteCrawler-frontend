...
const AssetDetailByCategory = ({
  ...
  <Card
    ...
    title={
      <FormattedMessage
        id="invest-assetallocation.detail.category.title"
        defaultMessage="Detail(Category)"
      />
    }
    style={{
      height: '100%',
      ...
      <div className={styles.salesTypeRadio}>
          <Radio.Group>
            <Radio.Button value="all">
              <FormattedMessage id="invest-assetallocation.detail.category.stockA" defaultMessage="StockA" />
            </Radio.Button>
            <Radio.Button value="online">
              <FormattedMessage id="invest-assetallocation.detail.category.fund" defaultMessage="Fund" />
            </Radio.Button>
            <Radio.Button value="stores">
              <FormattedMessage id="invest-assetallocation.detail.category.insurance" defaultMessage="Insurance" />
            </Radio.Button>
          </Radio.Group>
        </div>
...
export default AssetDetailByCategory;
